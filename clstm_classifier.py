...
class clstm_clf(object):
    ...
    def __init__(self, config):
        ...
        self.is_training = tf.placeholder(dtype=tf.bool, shape=(), name='is_now_training')
        ...
        for i, filter_size in enumerate(self.filter_sizes):
            with tf.variable_scope('conv-%s' % filter_size):
                ...
                # Improvement:卷积层后的Batch Normalization
                h_bn = tf.keras.layers.BatchNormalization()(h_reshape, training=self.is_training)

                conv_outputs.append(h_bn)
        ...
        with tf.variable_scope('LSTM'):
            ...
            # Improvement:LSTM层后的Batch Normalization
            outputs_bn = tf.keras.layers.BatchNormalization()(outputs, training=self.is_training)
