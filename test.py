...
with graph.as_default():
    ...
    is_training = graph.get_tensor_by_name('is_now_training:0')         # improvement need
    ...
    for batch in batches:
        ...
        if params['clf'] == 'cnn':
            feed_dict = {input_x: x_test, input_y: y_test, keep_prob: 1.0, is_training:False}
            ...
            feed_dict = {input_x: x_test, input_y: y_test, batch_size: FLAGS.batch_size, sequence_length: x_lengths, keep_prob: 1.0, is_training:False}
