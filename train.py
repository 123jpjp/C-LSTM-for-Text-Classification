...
# Training parametersW
tf.flags.DEFINE_integer('batch_size', 32, 'Batch size')
tf.flags.DEFINE_integer('num_epochs', 30, 'Number of epochs')
...
tf.flags.DEFINE_bool('is_now_training', True, 'Is now training(True) or testing(False)')
    ...
    with tf.Session() as sess:
        ...
        def run_step(input_data, is_training=True):
            ...
            feed_dict = {classifier.input_x: input_x,
                         ...
                         classifier.is_training: is_training}
